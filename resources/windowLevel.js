...
function adjustWLWW(){
		...
		var wlOff = function() {
            ...
            //document.getElementById("wcButton").style.background="transparent url('../../resources/icons/icn_bricon_off.png') no-repeat center 0px ";
...
function WLMouseOver(e) {
	document.getElementById("wcButton").style.background="transparent url('../../resources/icons/icn_bricon_on.png') no-repeat center 0px ";
