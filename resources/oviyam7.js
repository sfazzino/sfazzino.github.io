	...
	function gridView(){		
		...
		$("mosaicView").style.background="transparent url('../../resources/icons/icn_mosaic_0.gif') no-repeat";
		$("gridView").style.background="transparent url('../../resources/icons/icn_grid_1.gif') no-repeat";
	}
	...
	function mosaicView(){		
		...
		$("mosaicView").style.background="transparent url('../../resources/icons/icn_mosaic_1.gif') no-repeat";
		$("gridView").style.background="transparent url('../../resources/icons/icn_grid_0.gif') no-repeat";
	}	
	...
	function changeBlack(){
		...
		$("black").style.background="transparent url('../../resources/icons/icn_black_backColor.png') no-repeat scroll  0px -18px ";
		$("white").style.background="transparent url('../../resources/icons/icn_white_backColor.png') no-repeat scroll  0px -56px ";
		$("ltgrey").style.background="transparent url('../../resources/icons/icn_ltgrey_backColor.png') no-repeat scroll  0px -56px ";
		$("dkgrey").style.background="transparent url('../../resources/icons/icn_dkgrey_backColor.png') no-repeat scroll  0px -56px ";
	...
	function changeGray(){
		...
		$("dkgrey").style.background="transparent url('../../resources/icons/icn_dkgrey_backColor.png') no-repeat scroll  0px -18px ";
		$("white").style.background="transparent url('../../resources/icons/icn_white_backColor.png') no-repeat scroll  0px -56px ";
		$("black").style.background="transparent url('../../resources/icons/icn_black_backColor.png') no-repeat scroll  0px -56px ";
		$("ltgrey").style.background="transparent url('../../resources/icons/icn_ltgrey_backColor.png') no-repeat scroll  0px -56px ";
	}
	...
	function changeWhite(){
		...
		$("white").style.background="transparent url('../../resources/icons/icn_white_backColor.png') no-repeat scroll  0px -18px ";
		$("black").style.background="transparent url('../../resources/icons/icn_black_backColor.png') no-repeat scroll  0px -56px ";
		$("dkgrey").style.background="transparent url('../../resources/icons/icn_dkgrey_backColor.png') no-repeat scroll  0px -56px ";
		$("ltgrey").style.background="transparent url('../../resources/icons/icn_ltgrey_backColor.png') no-repeat scroll  0px -56px ";
	}
	...
	function changeLightGray(){
		...
		$("ltgrey").style.background="transparent url('../../resources/icons/icn_ltgrey_backColor.png') no-repeat scroll  0px -18px ";
		$("white").style.background="transparent url('../../resources/icons/icn_white_backColor.png') no-repeat scroll  0px -56px ";
		$("black").style.background="transparent url('../../resources/icons/icn_black_backColor.png') no-repeat scroll  0px -56px ";
		$("dkgrey").style.background="transparent url('../../resources/icons/icn_dkgrey_backColor.png') no-repeat scroll  0px -56px ";
	}	
	...
	function setPatientInfoVisible(patientName){
        ...
        window.document.title='Webviewer -'+patientName;
		if(!$('loadingText'))return;
		else
		$('loadingText').innerHTML='Loading series...';
		}
	...
	function hideSeries(){
		...
		if(hidesereis==0){
			...
			$("viewSeries").style.background="transparent url('../../resources/icons/icn_series_0.png') no-repeat";
			...
			$('gridView').style.color="#616161";
			$('mosaicView').style.color="#616161";
			$("viewSeries").style.background="transparent url('../../resources/icons/icn_series_1.png') no-repeat";
		}
	...
	function hideTools(){
		...
		if(hidetool==0){
			...
			$("hideButton").style.background="transparent url('../../resources/buttons/hide_tools1.gif') no-repeat scroll 0px 0px";
			...
			$("hideButton").style.background="transparent url('../../resources/buttons/show_tools.gif') no-repeat scroll 0px 0px";
	...
	function cineLoop(){
		...
		if(cineloop==0){			
			...
			$('cineLoop').style.background="url(../../resources/icons/icn_play_1.png)  0px center no-repeat";
			slideit();
		}else{
			cineloop=0;
			...
			$('cineLoop').style.background="url(../../resources/icons/icn_play_0.png)  0px center no-repeat";
	...
	function addRow(num,pageURL){
		...
		if(img.className=="expand"){			
			img.src="../../resources/TopMinus1.gif";
			img.className="shrink";
		}
		else{			
			img.src="../../resources/TopPlus1.gif";
	...
	function showFullResolution() {
      ...
      function setImageAndHeaders(img, frame){
		  ...
		  /* ********** */
		  var n = img.split("/");
		  var imgname = n[n.length - 1];
		  nativeRows = nativeRowsArray[imgname];
		  xPixelSpacing = xPixelSpacingArray[imgname];
		  yPixelSpacing = yPixelSpacingArray[imgname];
		  //alert("img: " + img);
		  /* ********** */
